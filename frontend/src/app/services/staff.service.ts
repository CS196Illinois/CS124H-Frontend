...
export class StaffService {
  ...
  public getStatus() {
    ...
    this.http
      .get<JSON>(
        "http://127.0.0.1:5000/api/get/get124Status",
        httpOptions
      ).subscribe((res) => {
  ...
  public addStaff(staffObj: string) {
    ...
    this.http
      .post(
        "http://127.0.0.1:5000/api/post/add124Staff",
        staffObj,
        httpOptions
      ).subscribe((res) => {
        console.log(res)
  ...
  public delStaff(email: string) {
    ...
    this.http
      .post(
        "http://127.0.0.1:5000/api/post/del124Staff",
        email,
        httpOptions
      ).subscribe((res) => {
        console.log(res)
  ...
  public getStaff(): Observable<JSON> {
    ...
    this.http
      .get<JSON>(
        "http://127.0.0.1:5000/api/get/get124Staff",
        httpOptions
      ).subscribe((res) => {
        this.staff.next(res)
      });
  ...
  public getStaffProfile(all = false): Observable<JSON> {
    if (!all) {
      ...
      this.http
        .get<JSON>(
          "http://127.0.0.1:5000/api/get/124/GetStaffProfile",
          httpOptions
        ).subscribe((res) => {
      ...
      this.http
        .get<JSON>(
          "http://127.0.0.1:5000/api/get/124/GetAllStaffProfile",
          httpOptions
        ).subscribe((res) => {
          console.log(res)
          this.staffProfile.next(res);
  ...
  public submitProfile(staffObj: string) {
    ...
    this.http
      .post(
        "http://127.0.0.1:5000/api/post/124/PostStaff",
        staffObj,
        httpOptions
      ).subscribe((res) => {
        console.log(res)
