import { Component, OnInit, NgModule, ChangeDetectorRef, NgZone } from '@angular/core';
...
export class DashboardComponent implements OnInit {
  ...
  constructor(private sanitizer: DomSanitizer, private LectureService: LectureService, private LoginService: LoginService,
    private ref: ChangeDetectorRef, private NgZone: NgZone, private router: Router, private route: ActivatedRoute, private StaffService: StaffService) { }
